...
## aggregate ranking
- `minimal_cleaning__deterministic_info`: rmse=5.9759, mae=4.9010, pearson=0.9407, spearman=0.9612
- `reconstruction_first__deterministic_info`: rmse=5.9759, mae=4.9010, pearson=0.9407, spearman=0.9612
- `reconstruction_first_relaxed__deterministic_info`: rmse=5.9759, mae=4.9010, pearson=0.9407, spearman=0.9612
- `reconstruction_first__random_cv`: rmse=7.4909, mae=5.7880, pearson=0.9061, spearman=0.9532
- `psychometric_default__deterministic_info`: rmse=7.7425, mae=6.4184, pearson=0.9671, spearman=0.9585
- `psychometric_default__random_cv`: rmse=9.6865, mae=8.0014, pearson=0.9113, spearman=0.8898
...
## recommendation
- winner: `minimal_cleaning__deterministic_info` (equal-weight rmse `5.9759`)
