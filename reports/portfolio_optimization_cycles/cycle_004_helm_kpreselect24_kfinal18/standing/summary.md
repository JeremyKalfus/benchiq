...
## aggregate ranking
- `minimal_cleaning__deterministic_info`: rmse=5.6718, mae=4.8263, pearson=0.9386, spearman=0.9612
- `reconstruction_first__deterministic_info`: rmse=5.6718, mae=4.8263, pearson=0.9386, spearman=0.9612
- `reconstruction_first_relaxed__deterministic_info`: rmse=5.6718, mae=4.8263, pearson=0.9386, spearman=0.9612
- `psychometric_default__deterministic_info`: rmse=5.8633, mae=4.5099, pearson=0.9473, spearman=0.9585
- `psychometric_default__random_cv`: rmse=6.8407, mae=5.8543, pearson=0.9616, spearman=0.9731
- `reconstruction_first__random_cv`: rmse=7.7964, mae=6.7683, pearson=0.6934, spearman=0.7032

## leave-one-out
- leaving out `helm_objective__capabilities_v1_0_0` -> winner `psychometric_default__random_cv`
- leaving out `ollb_v1_metabench_source__release_default_subset_20260405` -> winner `minimal_cleaning__deterministic_info`
...
## recommendation
- winner: `minimal_cleaning__deterministic_info` (equal-weight rmse `5.6718`)
