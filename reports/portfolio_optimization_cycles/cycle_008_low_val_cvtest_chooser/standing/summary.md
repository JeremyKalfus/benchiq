...
## aggregate ranking
- `psychometric_default__deterministic_info`: rmse=3.1589, mae=2.6103, pearson=0.9895, spearman=0.9893
- `minimal_cleaning__deterministic_info`: rmse=3.5281, mae=2.8507, pearson=0.9860, spearman=0.9703
- `reconstruction_first__deterministic_info`: rmse=3.5281, mae=2.8507, pearson=0.9860, spearman=0.9703
- `reconstruction_first_relaxed__deterministic_info`: rmse=3.5281, mae=2.8507, pearson=0.9860, spearman=0.9703
- `psychometric_default__random_cv`: rmse=4.3449, mae=3.6900, pearson=0.9875, spearman=0.9077
- `reconstruction_first__random_cv`: rmse=4.7093, mae=3.7642, pearson=0.9210, spearman=0.9235
...
## recommendation
- winner: `psychometric_default__deterministic_info` (equal-weight rmse `3.1589`)
