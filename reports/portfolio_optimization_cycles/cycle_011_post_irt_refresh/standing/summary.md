...
## aggregate ranking
- `psychometric_default__deterministic_info`: rmse=2.9344, mae=2.4051, pearson=0.9904, spearman=0.9911
- `minimal_cleaning__deterministic_info`: rmse=3.3339, mae=2.6894, pearson=0.9872, spearman=0.9736
- `reconstruction_first__deterministic_info`: rmse=3.3339, mae=2.6894, pearson=0.9872, spearman=0.9736
- `reconstruction_first_relaxed__deterministic_info`: rmse=3.3339, mae=2.6894, pearson=0.9872, spearman=0.9736
- `psychometric_default__random_cv`: rmse=4.0946, mae=3.4884, pearson=0.9888, spearman=0.9090
- `reconstruction_first__random_cv`: rmse=4.7085, mae=3.7399, pearson=0.9220, spearman=0.9252
...
## recommendation
- winner: `psychometric_default__deterministic_info` (equal-weight rmse `2.9344`)
